...
describe('Count lines in an image', () => {
  test('should detect lines in barcode image', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const rowsToScan = 3
  ...
  test('should detect lines in barcode image without padding', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const rowsToScan = 3
  ...
  test('should return zero lines with empty image', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const rowsToScan = 3
...
describe('get imageData from source', () => {
  test('should get imageData from file path', () =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  test.skip(
    'should get imageData from HTMLCanvasElement',
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
...
describe('extract barcode from local files', () => {
  test('should detect barcode codabar', () =>
    __awaiter(void 0, void 0, void 0, function* () {
  ...
  test('should detect barcode 2 of 5 standard', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode 2 of 5 interleaved', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode 128: ABC-abc-1234', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  // })
  test('should detect barcode EAN-8', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode EAN-13 small', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode EAN-13 large', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode 128 without padding white bars', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode 128 with multiple zeros', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode 128 with default start Code B', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode 93 without padding white bars', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
  ...
  test('should detect barcode 93 with bitmap data', () =>
    __awaiter(void 0, void 0, void 0, function* () {
...
describe('extract barcode after applying adaptive threhsold', () => {
  ...
  test('should detect barcode 2 of 5', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
        image: path.resolve('./test/sample-images/code-2of5.jpg'),
        barcode: 'code-2of5',
...
describe('extract barcode from local files - additional', () => {
  test('should detect barcode 93 from local file', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      const result = yield (0, index_1.default)({
        image: path.resolve('./test/sample-images/code-93-no-padding.jpg'),
        barcode: 'code-93',
...
describe('Fails', () => {
  test('throws when no barcode specified', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
  ...
  test('throws when invalid barcode specified', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        yield (0, index_1.default)({
  ...
  test('throws when no barcode found', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        yield (0, index_1.default)({
          image: './test/sample-images/empty.jpg',
